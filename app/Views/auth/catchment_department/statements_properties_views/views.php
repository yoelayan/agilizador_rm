...
<div class="content-wrapper">
    <div class="page-header flex-wrap">
        <div class="d-flex flex-wrap mt-md-2 mt-lg-0">
            <a href="/statements" class="btn btn-dark btn-sm d-flex align-items-center">
    ...
    <div class="tab-button-outer">
        ...
        <li><a href="#tab05">Calificación</a></li>
        </ul>
    </div>
    <div class="tab-select-outer">
        ...
        <option value="#tab05">Calificación</option>
        </select>
    </div>
    ...
    <div id="tab05" class="tab-contents">
        ...
        <form action="/statements/properties/views/<?= $property_data['id_properties'] ?>" method="post">
            <?= csrf_field() ?>
